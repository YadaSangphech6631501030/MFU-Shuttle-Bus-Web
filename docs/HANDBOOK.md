...
User Web โหลดสถานี/เส้นทางผ่าน `/api/public-data` และรับจำนวนคน สี และชื่อสถานะผ่าน Realtime; Admin Web ยังโหลดข้อมูลสถานีผ่าน API เดิม รายงานและ detector ยังใช้ API ตามเดิม
