...
const dictionary = {
  en: {
    ...
    mapMissingKey: 'Add VITE_GOOGLE_MAPS_API_KEY in root .env to enable Google Map picker.',
  ...
  th: {
    ...
    mapMissingKey: 'เพิ่ม VITE_GOOGLE_MAPS_API_KEY ใน root .env เพื่อเปิดใช้ Google Map',
